...
/* 25 */	"%0",	/* acon: con */
/* 26 */	"%a",	/* acon: ADDRGP2 */
/* 27 */	"%1(r%0)",	/* addr: ADDI2(reg,acon) */
/* 28 */	"%1(r%0)",	/* addr: ADDU2(reg,acon) */
/* 29 */	"%1(r%0)",	/* addr: ADDP2(reg,acon) */
/* 30 */	"%0",	/* addr: acon */
/* 31 */	"(r%0)",	/* addr: reg */
/* 32 */	"%a+%F(sp)",	/* addr: ADDRFP2 */
/* 33 */	"%a+%F(sp)",	/* addr: ADDRLP2 */
/* 34 */	"lea r%c,%0\n",	/* reg: addr */
/* 35 */	"# reg\n",	/* reg: CNSTI1 */
/* 36 */	"# reg\n",	/* reg: CNSTI2 */
/* 37 */	"# reg\n",	/* reg: CNSTI4 */
...
/* 150 */	"mov r%c,r%0\n",	/* reg: LOADP2(reg) */
/* 151 */	"mov r%c,r%0\n",	/* reg: LOADU4(reg) */
/* 152 */	"",	/* reg: ADDF4(reg,reg) */
/* 153 */	"",	/* reg: DIVF4(reg,reg) */
/* 154 */	"",	/* reg: MULF4(reg,reg) */
/* 155 */	"",	/* reg: SUBF4(reg,reg) */
/* 156 */	"",	/* reg: LOADF4(reg) */
/* 157 */	"",	/* reg: NEGF4(reg) */
/* 158 */	"sext r%c,r%0\n",	/* reg: CVII2(reg) */
/* 159 */	"zext r%c,r%0\n",	/* reg: CVUI2(reg) */
...
/* 218 */	"cmpi r%0,%1\nbne %a\n",	/* stmt: NEU2(reg,con) */
/* 219 */	"cmpil r%0,%1\nbne %a\n",	/* stmt: NEU4(reg,con) */
/* 220 */	"",	/* stmt: EQF4(reg,reg) */
/* 221 */	"",	/* stmt: LEF4(reg,reg) */
/* 222 */	"",	/* stmt: LTF4(reg,reg) */
/* 223 */	"",	/* stmt: GEF4(reg,reg) */
/* 224 */	"",	/* stmt: GTF4(reg,reg) */
/* 225 */	"",	/* stmt: NEF4(reg,reg) */
/* 226 */	"%a",	/* ar: ADDRGP2 */
/* 227 */	"call %0\n",	/* reg: CALLF4(ar) */
/* 228 */	"call %0\n",	/* reg: CALLI2(ar) */
/* 229 */	"call %0\n",	/* reg: CALLI4(ar) */
...
/* 73 */	1,	/* call _modu2\n */
/* 74 */	1,	/* call _modu4\n */
/* 75 */	1,	/* mul r%c,r%0,r%1\n */
/* 76 */	1,	/* call _muli4\n */
/* 77 */	1,	/* mul r%c,r%0,r%1\n */
/* 78 */	1,	/* call _mulu4\n */
/* 79 */	1,	/* add r%c,r%0,r%1\n */
/* 80 */	1,	/* addl r%c,r%0,r%1\n */
/* 81 */	1,	/* add r%c,r%0,r%1\n */
/* 82 */	1,	/* add r%c,r%0,r%1\n */
/* 83 */	1,	/* addl r%c,r%0,r%1\n */
/* 84 */	1,	/* ?mov r%c,r%0\nand r%c,r%1\n */
/* 85 */	1,	/* ?movl r%c,r%0\nandl r%c,r%1\n */
/* 86 */	1,	/* ?mov r%c,r%0\nor r%c,r%1\n */
/* 87 */	1,	/* ?movl r%c,r%0\norl r%c,r%1\n */
...
/* 94 */	1,	/* ?mov r%c,r%0\nxor r%c,r%1\n */
/* 95 */	1,	/* ?movl r%c,r%0\nxorl r%c,r%1\n */
/* 96 */	1,	/* sub r%c,r%0,r%1\n */
/* 97 */	1,	/* subl r%c,r%0,r%1\n */
/* 98 */	1,	/* sub r%c,r%0,r%1\n */
/* 99 */	1,	/* sub r%c,r%0,r%1\n */
/* 100 */	1,	/* subl r%c,r%0,r%1\n */
/* 101 */	1,	/* addi r%c,r%0,%1\n */
/* 102 */	1,	/* addil r%c,r%0,%1\n */
/* 103 */	1,	/* addi r%c,r%0,%1\n */
/* 104 */	1,	/* addi r%c,r%0,%1\n */
/* 105 */	1,	/* addil r%c,r%0,%1\n */
/* 106 */	1,	/* ?mov r%c,r%0\nandi r%c,%1\n */
/* 107 */	1,	/* ?movl r%c,r%0\nandil r%c,%1\n */
/* 108 */	1,	/* ?mov r%c,r%0\nori r%c,%1\n */
/* 109 */	1,	/* ?movl r%c,r%0\noril r%c,%1\n */
...
/* 116 */	1,	/* ?mov r%c,r%0\nxori r%c,%1\n */
/* 117 */	1,	/* ?movl r%c,r%0\nxoril r%c,%1\n */
/* 118 */	1,	/* subi r%c,r%0,%1\n */
/* 119 */	1,	/* subil r%c,r%0,%1\n */
/* 120 */	1,	/* subi r%c,r%0,%1\n */
/* 121 */	1,	/* subi r%c,r%0,%1\n */
/* 122 */	1,	/* subil r%c,r%0,%1\n */
/* 123 */	1,	/* ?mov r%c,r%0\nsll r%c,r%1\n */
/* 124 */	1,	/* call _slllr\n */
/* 125 */	1,	/* ?mov r%c,r%0\nsll r%c,r%1\n */
/* 126 */	1,	/* call _slllr\n */
...
/* 141 */	1,	/* ?mov r%c,r%0\nxori r%c,-1\n */
/* 142 */	1,	/* ?movl r%c,r%0\nxoril r%c,-1\n */
/* 143 */	1,	/* sub r%c,r0,r%0\n */
/* 144 */	1,	/* subl r%c,r0,r%0\n */
/* 145 */	1,	/* mov r%c,r%0\n */
/* 146 */	1,	/* mov r%c,r%0\n */
/* 147 */	1,	/* mov r%c,r%0\n */
/* 148 */	1,	/* mov r%c,r%0\n */
...
/* 79 */	"reg: ADDI2(reg,reg)",
/* 80 */	"reg: ADDI4(reg,reg)",
/* 81 */	"reg: ADDP2(reg,reg)",
/* 82 */	"reg: ADDU2(reg,reg)",
/* 83 */	"reg: ADDU4(reg,reg)",
/* 84 */	"reg: BANDI2(reg,reg)",
/* 85 */	"reg: BANDI4(reg,reg)",
/* 86 */	"reg: BORI2(reg,reg)",
/* 87 */	"reg: BORI4(reg,reg)",
/* 88 */	"reg: BXORI2(reg,reg)",
/* 89 */	"reg: BXORI4(reg,reg)",
/* 90 */	"reg: BANDU2(reg,reg)",
/* 91 */	"reg: BANDU4(reg,reg)",
/* 92 */	"reg: BORU2(reg,reg)",
/* 93 */	"reg: BORU4(reg,reg)",
/* 94 */	"reg: BXORU2(reg,reg)",
/* 95 */	"reg: BXORU4(reg,reg)",
/* 96 */	"reg: SUBI2(reg,reg)",
/* 97 */	"reg: SUBI4(reg,reg)",
/* 98 */	"reg: SUBP2(reg,reg)",
/* 99 */	"reg: SUBU2(reg,reg)",
/* 100 */	"reg: SUBU4(reg,reg)",
/* 101 */	"reg: ADDI2(reg,con)",
/* 102 */	"reg: ADDI4(reg,con)",
/* 103 */	"reg: ADDP2(reg,con)",
/* 104 */	"reg: ADDU2(reg,con)",
/* 105 */	"reg: ADDU4(reg,con)",
/* 106 */	"reg: BANDI2(reg,con)",
/* 107 */	"reg: BANDI4(reg,con)",
/* 108 */	"reg: BORI2(reg,con)",
/* 109 */	"reg: BORI4(reg,con)",
/* 110 */	"reg: BXORI2(reg,con)",
/* 111 */	"reg: BXORI4(reg,con)",
/* 112 */	"reg: BANDU2(reg,con)",
/* 113 */	"reg: BANDU4(reg,con)",
/* 114 */	"reg: BORU2(reg,con)",
/* 115 */	"reg: BORU4(reg,con)",
/* 116 */	"reg: BXORU2(reg,con)",
/* 117 */	"reg: BXORU4(reg,con)",
/* 118 */	"reg: SUBI2(reg,con)",
/* 119 */	"reg: SUBI4(reg,con)",
/* 120 */	"reg: SUBP2(reg,con)",
/* 121 */	"reg: SUBU2(reg,con)",
/* 122 */	"reg: SUBU4(reg,con)",
/* 123 */	"reg: LSHI2(reg,reg)",
/* 124 */	"reg: LSHI4(reg,reg)",
/* 125 */	"reg: LSHU2(reg,reg)",
/* 126 */	"reg: LSHU4(reg,reg)",
/* 127 */	"reg: RSHI2(reg,reg)",
/* 128 */	"reg: RSHI4(reg,reg)",
/* 129 */	"reg: RSHU2(reg,reg)",
/* 130 */	"reg: RSHU4(reg,reg)",
/* 131 */	"reg: LSHI2(reg,con)",
/* 132 */	"reg: LSHI4(reg,con)",
/* 133 */	"reg: LSHU2(reg,con)",
/* 134 */	"reg: LSHU4(reg,con)",
/* 135 */	"reg: RSHI2(reg,con)",
/* 136 */	"reg: RSHI4(reg,con)",
/* 137 */	"reg: RSHU2(reg,con)",
/* 138 */	"reg: RSHU4(reg,con)",
/* 139 */	"reg: BCOMI2(reg)",
/* 140 */	"reg: BCOMI4(reg)",
/* 141 */	"reg: BCOMU2(reg)",
/* 142 */	"reg: BCOMU4(reg)",
...
/* 170 */	"stmt: JUMPV(acon)",
/* 171 */	"stmt: JUMPV(reg)",
/* 172 */	"stmt: EQI2(reg,reg)",
/* 173 */	"stmt: EQI4(reg,reg)",
/* 174 */	"stmt: EQU2(reg,reg)",
/* 175 */	"stmt: EQU4(reg,reg)",
/* 176 */	"stmt: GEI2(reg,reg)",
/* 177 */	"stmt: GEI4(reg,reg)",
/* 178 */	"stmt: GEU2(reg,reg)",
/* 179 */	"stmt: GEU4(reg,reg)",
/* 180 */	"stmt: GTI2(reg,reg)",
/* 181 */	"stmt: GTI4(reg,reg)",
/* 182 */	"stmt: GTU2(reg,reg)",
/* 183 */	"stmt: GTU4(reg,reg)",
/* 184 */	"stmt: LEI2(reg,reg)",
/* 185 */	"stmt: LEI4(reg,reg)",
/* 186 */	"stmt: LEU2(reg,reg)",
/* 187 */	"stmt: LEU4(reg,reg)",
/* 188 */	"stmt: LTI2(reg,reg)",
/* 189 */	"stmt: LTI4(reg,reg)",
/* 190 */	"stmt: LTU2(reg,reg)",
/* 191 */	"stmt: LTU4(reg,reg)",
/* 192 */	"stmt: NEI2(reg,reg)",
/* 193 */	"stmt: NEI4(reg,reg)",
/* 194 */	"stmt: NEU2(reg,reg)",
/* 195 */	"stmt: NEU4(reg,reg)",
/* 196 */	"stmt: EQI2(reg,con)",
/* 197 */	"stmt: EQI4(reg,con)",
/* 198 */	"stmt: EQU2(reg,con)",
/* 199 */	"stmt: EQU4(reg,con)",
/* 200 */	"stmt: GEI2(reg,con)",
/* 201 */	"stmt: GEI4(reg,con)",
/* 202 */	"stmt: GEU2(reg,con)",
/* 203 */	"stmt: GEU4(reg,con)",
/* 204 */	"stmt: GTI2(reg,con)",
/* 205 */	"stmt: GTI4(reg,con)",
/* 206 */	"stmt: GTU2(reg,con)",
/* 207 */	"stmt: GTU4(reg,con)",
/* 208 */	"stmt: LEI2(reg,con)",
/* 209 */	"stmt: LEI4(reg,con)",
/* 210 */	"stmt: LEU2(reg,con)",
/* 211 */	"stmt: LEU4(reg,con)",
/* 212 */	"stmt: LTI2(reg,con)",
/* 213 */	"stmt: LTI4(reg,con)",
/* 214 */	"stmt: LTU2(reg,con)",
/* 215 */	"stmt: LTU4(reg,con)",
/* 216 */	"stmt: NEI2(reg,con)",
/* 217 */	"stmt: NEI4(reg,con)",
/* 218 */	"stmt: NEU2(reg,con)",
/* 219 */	"stmt: NEU4(reg,con)",
/* 220 */	"stmt: EQF4(reg,reg)",
/* 221 */	"stmt: LEF4(reg,reg)",
/* 222 */	"stmt: LTF4(reg,reg)",
/* 223 */	"stmt: GEF4(reg,reg)",
...
static void _kids(NODEPTR_TYPE p, int eruleno, NODEPTR_TYPE kids[]) {
	...
	case 24: /* stmt: reg */
		kids[0] = p;
		break;
	case 225: /* stmt: NEF4(reg,reg) */
	case 224: /* stmt: GTF4(reg,reg) */
	case 223: /* stmt: GEF4(reg,reg) */
	case 222: /* stmt: LTF4(reg,reg) */
	case 221: /* stmt: LEF4(reg,reg) */
	case 220: /* stmt: EQF4(reg,reg) */
	case 219: /* stmt: NEU4(reg,con) */
	case 218: /* stmt: NEU2(reg,con) */
	case 217: /* stmt: NEI4(reg,con) */
	case 216: /* stmt: NEI2(reg,con) */
	case 215: /* stmt: LTU4(reg,con) */
	case 214: /* stmt: LTU2(reg,con) */
	case 213: /* stmt: LTI4(reg,con) */
	case 212: /* stmt: LTI2(reg,con) */
	case 211: /* stmt: LEU4(reg,con) */
	case 210: /* stmt: LEU2(reg,con) */
	case 209: /* stmt: LEI4(reg,con) */
	case 208: /* stmt: LEI2(reg,con) */
	case 207: /* stmt: GTU4(reg,con) */
	case 206: /* stmt: GTU2(reg,con) */
	case 205: /* stmt: GTI4(reg,con) */
	case 204: /* stmt: GTI2(reg,con) */
	case 203: /* stmt: GEU4(reg,con) */
	case 202: /* stmt: GEU2(reg,con) */
	case 201: /* stmt: GEI4(reg,con) */
	case 200: /* stmt: GEI2(reg,con) */
	case 199: /* stmt: EQU4(reg,con) */
	case 198: /* stmt: EQU2(reg,con) */
	case 197: /* stmt: EQI4(reg,con) */
	case 196: /* stmt: EQI2(reg,con) */
	case 195: /* stmt: NEU4(reg,reg) */
	case 194: /* stmt: NEU2(reg,reg) */
	case 193: /* stmt: NEI4(reg,reg) */
	case 192: /* stmt: NEI2(reg,reg) */
	case 191: /* stmt: LTU4(reg,reg) */
	case 190: /* stmt: LTU2(reg,reg) */
	case 189: /* stmt: LTI4(reg,reg) */
	case 188: /* stmt: LTI2(reg,reg) */
	case 187: /* stmt: LEU4(reg,reg) */
	case 186: /* stmt: LEU2(reg,reg) */
	case 185: /* stmt: LEI4(reg,reg) */
	case 184: /* stmt: LEI2(reg,reg) */
	case 183: /* stmt: GTU4(reg,reg) */
	case 182: /* stmt: GTU2(reg,reg) */
	case 181: /* stmt: GTI4(reg,reg) */
	case 180: /* stmt: GTI2(reg,reg) */
	case 179: /* stmt: GEU4(reg,reg) */
	case 178: /* stmt: GEU2(reg,reg) */
	case 177: /* stmt: GEI4(reg,reg) */
	case 176: /* stmt: GEI2(reg,reg) */
	case 175: /* stmt: EQU4(reg,reg) */
	case 174: /* stmt: EQU2(reg,reg) */
	case 173: /* stmt: EQI4(reg,reg) */
	case 172: /* stmt: EQI2(reg,reg) */
	case 155: /* reg: SUBF4(reg,reg) */
	case 154: /* reg: MULF4(reg,reg) */
	case 153: /* reg: DIVF4(reg,reg) */
	case 152: /* reg: ADDF4(reg,reg) */
	case 138: /* reg: RSHU4(reg,con) */
	case 137: /* reg: RSHU2(reg,con) */
	case 136: /* reg: RSHI4(reg,con) */
	case 135: /* reg: RSHI2(reg,con) */
	case 134: /* reg: LSHU4(reg,con) */
	case 133: /* reg: LSHU2(reg,con) */
	case 132: /* reg: LSHI4(reg,con) */
	case 131: /* reg: LSHI2(reg,con) */
	case 130: /* reg: RSHU4(reg,reg) */
	case 129: /* reg: RSHU2(reg,reg) */
	case 128: /* reg: RSHI4(reg,reg) */
	case 127: /* reg: RSHI2(reg,reg) */
	case 126: /* reg: LSHU4(reg,reg) */
	case 125: /* reg: LSHU2(reg,reg) */
	case 124: /* reg: LSHI4(reg,reg) */
	case 123: /* reg: LSHI2(reg,reg) */
	case 122: /* reg: SUBU4(reg,con) */
	case 121: /* reg: SUBU2(reg,con) */
	case 120: /* reg: SUBP2(reg,con) */
	case 119: /* reg: SUBI4(reg,con) */
	case 118: /* reg: SUBI2(reg,con) */
	case 117: /* reg: BXORU4(reg,con) */
	case 116: /* reg: BXORU2(reg,con) */
	case 115: /* reg: BORU4(reg,con) */
	case 114: /* reg: BORU2(reg,con) */
	case 113: /* reg: BANDU4(reg,con) */
	case 112: /* reg: BANDU2(reg,con) */
	case 111: /* reg: BXORI4(reg,con) */
	case 110: /* reg: BXORI2(reg,con) */
	case 109: /* reg: BORI4(reg,con) */
	case 108: /* reg: BORI2(reg,con) */
	case 107: /* reg: BANDI4(reg,con) */
	case 106: /* reg: BANDI2(reg,con) */
	case 105: /* reg: ADDU4(reg,con) */
	case 104: /* reg: ADDU2(reg,con) */
	case 103: /* reg: ADDP2(reg,con) */
	case 102: /* reg: ADDI4(reg,con) */
	case 101: /* reg: ADDI2(reg,con) */
	case 100: /* reg: SUBU4(reg,reg) */
	case 99: /* reg: SUBU2(reg,reg) */
	case 98: /* reg: SUBP2(reg,reg) */
	case 97: /* reg: SUBI4(reg,reg) */
	case 96: /* reg: SUBI2(reg,reg) */
	case 95: /* reg: BXORU4(reg,reg) */
	case 94: /* reg: BXORU2(reg,reg) */
	case 93: /* reg: BORU4(reg,reg) */
	case 92: /* reg: BORU2(reg,reg) */
	case 91: /* reg: BANDU4(reg,reg) */
	case 90: /* reg: BANDU2(reg,reg) */
	case 89: /* reg: BXORI4(reg,reg) */
	case 88: /* reg: BXORI2(reg,reg) */
	case 87: /* reg: BORI4(reg,reg) */
	case 86: /* reg: BORI2(reg,reg) */
	case 85: /* reg: BANDI4(reg,reg) */
	case 84: /* reg: BANDI2(reg,reg) */
	case 83: /* reg: ADDU4(reg,reg) */
	case 82: /* reg: ADDU2(reg,reg) */
	case 81: /* reg: ADDP2(reg,reg) */
	case 80: /* reg: ADDI4(reg,reg) */
	case 79: /* reg: ADDI2(reg,reg) */
	...
	case 27: /* addr: ADDI2(reg,acon) */
		...
		break;
	case 248: /* stmt: ARGU4(reg) */
	case 247: /* stmt: ARGU2(reg) */
	case 246: /* stmt: ARGP2(reg) */
	case 245: /* stmt: ARGI4(reg) */
	case 244: /* stmt: ARGI2(reg) */
	case 243: /* stmt: ARGF4(reg) */
	case 242: /* stmt: RETV(reg) */
	case 241: /* stmt: RETP2(reg) */
	case 240: /* stmt: RETU4(reg) */
	case 239: /* stmt: RETU2(reg) */
	case 238: /* stmt: RETI4(reg) */
	case 237: /* stmt: RETI2(reg) */
	case 236: /* stmt: RETF4(reg) */
	case 233: /* stmt: CALLV(ar) */
	case 232: /* reg: CALLU4(ar) */
	case 231: /* reg: CALLU2(ar) */
	case 230: /* reg: CALLP2(ar) */
	case 229: /* reg: CALLI4(ar) */
	case 228: /* reg: CALLI2(ar) */
	case 227: /* reg: CALLF4(ar) */
	case 171: /* stmt: JUMPV(reg) */
	case 170: /* stmt: JUMPV(acon) */
	case 168: /* reg: CVFI4(reg) */
	case 167: /* reg: CVFI2(reg) */
	case 166: /* reg: CVIF4(reg) */
	case 165: /* reg: CVFF4(reg) */
	case 164: /* reg: CVUU4(reg) */
	case 163: /* reg: CVUI4(reg) */
	case 162: /* reg: CVIU4(reg) */
	case 161: /* reg: CVII4(reg) */
	case 160: /* reg: CVUU2(reg) */
	case 159: /* reg: CVUI2(reg) */
	case 158: /* reg: CVII2(reg) */
	case 157: /* reg: NEGF4(reg) */
	case 156: /* reg: LOADF4(reg) */
	case 151: /* reg: LOADU4(reg) */
	case 150: /* reg: LOADP2(reg) */
	case 149: /* reg: LOADI4(reg) */
	case 148: /* reg: LOADU2(reg) */
	case 147: /* reg: LOADI2(reg) */
	case 146: /* reg: LOADU1(reg) */
	case 145: /* reg: LOADI1(reg) */
	case 144: /* reg: NEGI4(reg) */
	case 143: /* reg: NEGI2(reg) */
	case 142: /* reg: BCOMU4(reg) */
	case 141: /* reg: BCOMU2(reg) */
	case 140: /* reg: BCOMI4(reg) */
	case 139: /* reg: BCOMI2(reg) */
