 ...
 * 20-05-07 just decorating the CALLxx expressions
 *
...
static short _nts_18[] = { _reg_NT, _con8bit_NT, 0 };
static short _nts_19[] = { _reg_NT, _con0_NT, 0 };
...
/* 42 */	"'O',R%0,0",	/* addr: reg */
/* 43 */	"R%0",	/* indaddr: reg */
/* 44 */	"'O',sp,(%A+1)",	/* addr: ADDRFP2 */
/* 45 */	"'O',sp,(%A+1)",	/* addr: ADDRLP2 */
/* 46 */	"?\tcpy2 R%c,R%0 ;reg:ADDI2(consm,reg)\n\tincm R%c,%1\n",	/* reg: ADDI2(reg,consm) */
/* 47 */	"?\tcpy2 R%c,R%0\n\tincm R%c,%1\n",	/* reg: ADDU2(reg,consm) */
/* 48 */	"?\tcpy2 R%c,R%0\n\tincm R%c,%1\n",	/* reg: ADDP2(reg,consm) */
/* 49 */	"?\tcpy2 R%c,R%0	;SUBI2(reg,consm)\n\tdecm R%c,%1	;SUBI2(reg,consm)\n",	/* reg: SUBI2(reg,consm) */
/* 50 */	"?\tcpy2 R%c,R%0	;SUBU2(reg,consm)\n\tdecm R%c,%1	;SUBU2(reg,consm)\n",	/* reg: SUBU2(reg,consm) */
/* 51 */	"?\tcpy2 R%c,R%0\n\tdecm R%c,%1	; SUBP2(reg,consm)\n",	/* reg: SUBP2(reg,consm) */
/* 52 */	"\tld2z R%c; reg:con0\n",	/* reg: con0 */
...
/* 60 */	"\tstr1 R%1,%0; ASGNU1(indaddr,LOADU1(LOADU2(reg))) 18-03-21\n",	/* stmt: ASGNU1(indaddr,LOADU1(LOADU2(reg))) */
/* 61 */	"\tst2I %1,%0; ASGNI2(addr,acon)\n",	/* stmt: ASGNI2(addr,acon) */
/* 62 */	"\tst2 R%1,%0; ASGNI2(addr,reg)\n",	/* stmt: ASGNI2(addr,reg) */
/* 63 */	"\tst2 R%1,%0; ASGNI2(addr,LOADI2(reg)) 18-02-26\n",	/* stmt: ASGNI2(addr,LOADI2(reg)) */
/* 64 */	"\tst2 R%1,%0; ASGNU2(addr,reg)\n",	/* stmt: ASGNU2(addr,reg) */
/* 65 */	"\tst2 R%1,%0; ASGNU2(addr,LOADU2(reg)) 18-02-26\n",	/* stmt: ASGNU2(addr,LOADU2(reg)) */
/* 66 */	"\tst2 R%1,%0; ASGNI2(addr,LOADI2(reg)) 18-03-22\n",	/* stmt: ASGNI2(addr,LOADI2(reg)) */
/* 67 */	"\tst2 R%1,%0; ASGNP2(addr,reg)\n",	/* stmt: ASGNP2(addr,reg) */
/* 68 */	"\tst4 R%1,%0\n",	/* stmt: ASGNI4(addr,reg) */
/* 69 */	"\tst4 R%1,%0; ASGNU4\n",	/* stmt: ASGNU4(addr,reg) */
/* 70 */	"\tldn1 R%c,%0;reg:  INDIRI1(indaddr)\n",	/* reg: INDIRI1(indaddr) */
/* 71 */	"\tldn1 R%c,%0;reg:  INDIRU1(indaddr)\n",	/* reg: INDIRU1(indaddr) */
/* 72 */	"\tld1 R%c,%0\n",	/* reg: INDIRI1(addr) */
/* 73 */	"\tld1 R%c,%0\n",	/* reg: INDIRU1(addr) */
/* 74 */	"\tld2 R%c,%0 ;reg:INDIRI2(addr)\n",	/* reg: INDIRI2(addr) */
/* 75 */	"\tld2 R%c,%0 ;reg:INDIRU2(addr)\n",	/* reg: INDIRU2(addr) */
/* 76 */	"\tld2 R%c,%0 ;reg:INDIRP2(addr)\n",	/* reg: INDIRP2(addr) */
/* 77 */	"\tld4 R%c,%0;reg:  INDIRI4(addr)\n",	/* reg: INDIRI4(addr) */
/* 78 */	"\tld4 R%c,%0;reg:  INDIRU4(addr)\n",	/* reg: INDIRU4(addr) */
...
/* 88 */	"\tCcall _divi2\n",	/* reg: DIVI2(reg,reg) */
/* 89 */	"\tshri4I R%c,1; DIVI4(reg,2)\n",	/* reg: DIVI4(reg,con2) */
/* 90 */	"\tCcall _divi4; DIVI4(reg,reg)\n",	/* reg: DIVI4(reg,reg) */
/* 91 */	"\tCcall _divu2\n",	/* reg: DIVU2(reg,reg) */
/* 92 */	"\tCcall _divu4\n",	/* reg: DIVU4(reg,reg) */
/* 93 */	"\tCcall _modi2\n",	/* reg: MODI2(reg,reg) */
/* 94 */	"\tCcall _modi4\n",	/* reg: MODI4(reg,reg) */
/* 95 */	"\tCcall _modu2\n",	/* reg: MODU2(reg,reg) */
/* 96 */	"\tCcall _modu4\n",	/* reg: MODU4(reg,reg) */
/* 97 */	"\tCcall _mulu2; was mulI2 R%c,R%0,R%1\n",	/* reg: MULI2(reg,reg) */
/* 98 */	"#\tCcall _mul8bit(%0); was mulI2 R%c,R%0,R%1\n",	/* reg: MULI2(con8bit,reg) */
/* 99 */	"\tCcall _mulu4\n",	/* reg: MULI4(reg,reg) */
/* 100 */	"\tCcall _mulu2; was mulU2 R%c,R%0,R%1\n",	/* reg: MULU2(reg,reg) */
/* 101 */	"\tCcall _mulu4\n",	/* reg: MULU4(reg,reg) */
/* 102 */	"\talu2RRS R%c,R%0,%1,add,adc; ADDI2(r,INDIRI2(addr))	DH3\n",	/* reg: ADDI2(reg,INDIRI2(addr)) */
/* 103 */	"\talu2 R%c,R%0,R%1,add,adc; ADDI2(r,r)\n",	/* reg: ADDI2(reg,reg) */
/* 104 */	"\talu4 R%c,R%0,R%1,add,adc\n",	/* reg: ADDI4(reg,reg) */
/* 105 */	"\talu2RRS R%c,R%0,%1,add,adc; ADDI2(r,INDIRP2(addr))	DH3.1\n",	/* reg: ADDP2(reg,INDIRP2(addr)) */
/* 106 */	"\talu2 R%c,R%0,R%1,add,adc	;ADDP2(reg,reg)\n",	/* reg: ADDP2(reg,reg) */
/* 107 */	"\talu2 R%c,R%0,R%1,add,adc; ADDU2(r,r)\n",	/* reg: ADDU2(reg,reg) */
/* 108 */	"\talu4 R%c,R%0,R%1,add,adc\n",	/* reg: ADDU4(reg,reg) */
/* 109 */	"\talu2 R%c,R%0,R%1,and,and\n",	/* reg: BANDI2(reg,reg) */
/* 110 */	"\talu4 R%c,R%0,R%1,and,and\n",	/* reg: BANDI4(reg,reg) */
/* 111 */	"\talu2 R%c,R%0,R%1,or,or\n",	/* reg: BORI2(reg,reg) */
/* 112 */	"\talu4 R%c,R%0,R%1,or,or\n",	/* reg: BORI4(reg,reg) */
/* 113 */	"\talu2 R%c,R%0,R%1,xor,xor\n",	/* reg: BXORI2(reg,reg) */
/* 114 */	"\talu4 R%c,R%0,R%1,xor,xor\n",	/* reg: BXORI4(reg,reg) */
/* 115 */	"\talu2 R%c,R%0,R%1,and,and; BANDU2(reg,reg)\n",	/* reg: BANDU2(reg,reg) */
/* 116 */	"\talu4 R%c,R%0,R%1,and,and\n",	/* reg: BANDU4(reg,reg) */
/* 117 */	"\talu2 R%c,R%0,R%1,or,or\n",	/* reg: BORU2(reg,reg) */
/* 118 */	"\talu4 R%c,R%0,R%1,or,or\n",	/* reg: BORU4(reg,reg) */
/* 119 */	"\talu2 R%c,R%0,R%1,xor,xor\n",	/* reg: BXORU2(reg,reg) */
/* 120 */	"\talu4 R%c,R%0,R%1,xor,xor\n",	/* reg: BXORU4(reg,reg) */
/* 121 */	"\talu2 R%c,R%0,R%1,sm,smb\n",	/* reg: SUBI2(reg,reg) */
/* 122 */	"\talu4 R%c,R%0,R%1,sm,smb\n",	/* reg: SUBI4(reg,reg) */
/* 123 */	"\talu2 R%c,R%0,R%1,sm,smb\n",	/* reg: SUBP2(reg,reg) */
/* 124 */	"\talu2 R%c,R%0,R%1,sm,smb\n",	/* reg: SUBU2(reg,reg) */
/* 125 */	"\talu4 R%c,R%0,R%1,sm,smb\n",	/* reg: SUBU4(reg,reg) */
/* 126 */	"\talu2I R%c,R%0,%1,adi,adci; ADDI2(reg,con)\n",	/* reg: ADDI2(reg,con) */
/* 127 */	"\talu4I R%c,R%0,%1,adi,adci\n",	/* reg: ADDI4(reg,con) */
/* 128 */	"\talu2I R%c,R%0,%1,adi,adci; ADDP2(reg,con)\n",	/* reg: ADDP2(reg,con) */
/* 129 */	"\talu2I R%c,R%0,%1,adi,adci; ADDU2(reg,con)\n",	/* reg: ADDU2(reg,con) */
/* 130 */	"\talu4I R%c,R%0,%1,adi,adci\n",	/* reg: ADDU4(reg,con) */
/* 131 */	"\talu2I R%c,R%0,%1,ani,ani\n	;removed ?\tcpy2 R%c,R%0\n",	/* reg: BANDI2(reg,con) */
/* 132 */	"?\tcpy4 R%c,R%0\n\talu4I R%c,R%0,%1,ani,ani\n",	/* reg: BANDI4(reg,con) */
/* 133 */	"\talu2I R%c,R%0,%1,ori,ori ;removed copy\n",	/* reg: BORI2(reg,con) */
/* 134 */	"?\tcpy4 R%c,R%0\n\talu4I R%c,R%0,%1,ori,ori\n",	/* reg: BORI4(reg,con) */
/* 135 */	"\talu2I R%c,R%0,%1,xri,xri ;removed copy\n",	/* reg: BXORI2(reg,con) */
/* 136 */	"?\tcpy4 R%c,R%0\n\talu2I R%c,R%0,%1,xri,xri\n",	/* reg: BXORI4(reg,con) */
/* 137 */	"\talu2I R%c,R%0,%1,ani,ani ;removed copy;BANDU2(reg,con)  \n",	/* reg: BANDU2(reg,con) */
/* 138 */	"?\tcpy4 R%c,R%0\n\talu4I R%c,R%0,%1,ani,ani\n",	/* reg: BANDU4(reg,con) */
/* 139 */	"\talu2I R%c,R%0,%1,ori,ori ;removed copy\n",	/* reg: BORU2(reg,con) */
/* 140 */	"?\tcpy4 R%c,R%0\n\talu4I R%c,R%0,%1,ori,ori\n",	/* reg: BORU4(reg,con) */
/* 141 */	"\talu2I R%c,R%0,%1,xri,xri ;removed copy\n",	/* reg: BXORU2(reg,con) */
/* 142 */	"?\tcpy4 R%c,R%0\n\talu2I R%c,R%0,%1,xri,xri\n",	/* reg: BXORU4(reg,con) */
/* 143 */	"\talu2I R%c,R%0,%1,smi,smbi\n",	/* reg: SUBI2(reg,con) */
/* 144 */	"\talu4I R%c,R%0,%1,smi,smbi\n",	/* reg: SUBI4(reg,con) */
/* 145 */	"\talu2I R%c,R%0,%1,smi,smbi\n",	/* reg: SUBP2(reg,con) */
/* 146 */	"\talu2I R%c,R%0,%1,smi,smbi\n",	/* reg: SUBU2(reg,con) */
/* 147 */	"\talu4I R%c,R%0,%1,smi,smbi\n",	/* reg: SUBU4(reg,con) */
...
/* 162 */	"?\tcpy2 R%c,R%0\n\tshrU2I R%c,%1\n",	/* reg: RSHU2(reg,con) */
/* 163 */	"?\tcpy4 R%c,R%0\n\tshrU4I R%c,%1\n",	/* reg: RSHU4(reg,con) */
/* 164 */	"\talu2I R%c,R%0,-1,xri,xri; was?\tcpy2 R%c,R%0+xor2I R%c,-1\n",	/* reg: BCOMI2(reg) */
/* 165 */	"\talu4I R%c,R%0,-1,xri,xri; was?\tcpy4 R%c,R%0+xor4I R%c,-1\n",	/* reg: BCOMI4(reg) */
/* 166 */	"\talu2I R%c,R%0,-1,xri,xri; was?\tcpy2 R%c,R%0+xor2I R%c,-1\n",	/* reg: BCOMU2(reg) */
/* 167 */	"\talu4I R%c,R%0,-1,xri,xri; was?\tcpy4 R%c,R%0+xor4I R%c,-1\n",	/* reg: BCOMU4(reg) */
/* 168 */	"\tnegI2 R%c,R%0 ;was alu2I R%c,R%0,0,sdi,sdbi\n",	/* reg: NEGI2(reg) */
/* 169 */	"\tnegI4 R%c,R%0 ;was alu4I R%c,R%0,0,sdi,sdbi\n",	/* reg: NEGI4(reg) */
/* 170 */	"?\tcpy1 R%c,R%0;LOADI1(reg)\n",	/* reg: LOADI1(reg) */
/* 171 */	"?\tcpy1 R%c,R%0;LOADU1(reg)\n",	/* reg: LOADU1(reg) */
/* 172 */	"?\tcpy2 R%c,R%0 ;LOADI2(reg)\n",	/* reg: LOADI2(reg) */
/* 173 */	"\tdecm R%c,%1	;LOADU2(SUBU2(reg,consm))\n",	/* reg: LOADU2(SUBU2(reg,consm)) */
/* 174 */	"?\tcpy2 R%c,R%0 ;LOADU2*(reg)\n",	/* reg: LOADU2(reg) */
/* 175 */	"?\tcpy4 R%c,R%0; LOADI4*\n",	/* reg: LOADI4(reg) */
/* 176 */	"?\tcpy2 R%c,R%0 ;LOADP2(reg)\n",	/* reg: LOADP2(reg) */
/* 177 */	"?\tcpy4 R%c,R%0; LOADU4(reg)\n",	/* reg: LOADU4(reg) */
/* 178 */	"\tld4 R%c,%0;INDIRF4(addr)\n",	/* reg: INDIRF4(addr) */
/* 179 */	"\tst4 R%1,%0; ASGNF4(addr,reg)\n",	/* stmt: ASGNF4(addr,reg) */
/* 180 */	"\tCcall fp_add ;ADDF4(reg,reg)\n",	/* reg: ADDF4(reg,reg) */
/* 181 */	"\tCcall fp_div ;DIVF4(reg,reg)\n",	/* reg: DIVF4(reg,reg) */
/* 182 */	"\tCcall fp_mul ;MULF4(reg,reg)\n",	/* reg: MULF4(reg,reg) */
/* 183 */	"\tCcall fp_sub ;SUBF4(reg,reg)\n",	/* reg: SUBF4(reg,reg) */
/* 184 */	"?\tcpy4 R%c,R%0; LOADU4(reg)\n",	/* reg: LOADF4(reg) */
/* 185 */	"\tnegf4 R%c,R%0; NEGF4(reg)",	/* reg: NEGF4(reg) */
/* 186 */	"?\tcpy1 R%c,R%0\n\tsExt R%c ;CVII2: widen signed char to signed int (sign extend)\n",	/* reg: CVII2(reg) */
...
/* 194 */	"?\tcpy2 R%c,R%0\n\tzext4 R%c ; CVUU4\n",	/* reg: CVUU4(reg) */
/* 195 */	"",	/* reg: CVFF4(reg) */
/* 196 */	"#\tcvif4 %c,%0 ; CVIF4(reg) convert int/long to float\n",	/* reg: CVIF4(reg) */
/* 197 */	"\tccall cvfi4; CVFI4(reg) convert float to long(should work for int's)\n",	/* reg: CVFI2(reg) */
/* 198 */	"\tccall cvfi4; CVFI4(reg) convert float to long\n",	/* reg: CVFI4(reg) */
/* 199 */	"%a:\n",	/* stmt: LABELV */
/* 200 */	"\tlbr %0\n",	/* stmt: JUMPV(acon) */
/* 201 */	"\tjumpv R%0; JUMPV(reg)\n",	/* stmt: JUMPV(reg) */
/* 202 */	"\tjeqI2 R%0,R%1,%a; EQI2(reg,reg)\n",	/* stmt: EQI2(reg,reg) */
/* 203 */	"\tjeqI2 R%0,R%1,%a;EQU2(reg,reg)\n",	/* stmt: EQU2(reg,reg) */
/* 204 */	"\tjcI2 R%0,R%1,lbdf,%a; GE is flipped test from LT\n",	/* stmt: GEI2(reg,reg) */
/* 205 */	"\tjcU2 R%0,R%1,lbdf,%a; GE is flipped test from LT\n",	/* stmt: GEU2(reg,reg) */
/* 206 */	"\tjcI2 R%1,R%0,lbnf,%a ;GT is reversed operands from LT\n",	/* stmt: GTI2(reg,reg) */
/* 207 */	"\tjcU2 R%1,R%0,lbnf,%a ;GT same as LT but operands reversed\n",	/* stmt: GTU2(reg,reg) */
/* 208 */	"\tjcI2 R%1,R%0,lbdf,%a ;LE is flipped test & operands\n",	/* stmt: LEI2(reg,reg) */
/* 209 */	"\tjcU2 R%1,R%0,lbdf,%a ;LE is flipped test & operands\n",	/* stmt: LEU2(reg,reg) */
/* 210 */	"\tjcI2 R%0,R%1,lbnf,%a; LT=lbnf i.e. subtract B from A and jump if borrow \n",	/* stmt: LTI2(reg,reg) */
/* 211 */	"\tjcU2 R%0,R%1,lbnf,%a; LT=lbnf i.e. subtract B from A and jump if borrow \n",	/* stmt: LTU2(reg,reg) */
/* 212 */	"\tjneU2 R%0,R%1,%a; NE\n",	/* stmt: NEI2(reg,reg) */
/* 213 */	"\tjneU2 R%0,R%1,%a; NE\n",	/* stmt: NEU2(reg,reg) */
/* 214 */	"\tjeqI4 R%0,R%1,%a\n",	/* stmt: EQI4(reg,reg) */
/* 215 */	"\tjeqI4 R%0,R%1,%a\n",	/* stmt: EQU4(reg,reg) */
/* 216 */	"\tjcI4 R%0,R%1,lbdf,%a; GE is flipped test from LT\n",	/* stmt: GEI4(reg,reg) */
/* 217 */	"\tjcU4 R%0,R%1,lbdf,%a; GE is flipped test from LT\n",	/* stmt: GEU4(reg,reg) */
/* 218 */	"\tjcI4 R%1,R%0,lbnf,%a ;GT is reveresed operands from LT\n",	/* stmt: GTI4(reg,reg) */
/* 219 */	"\tjcU4 R%1,R%0,lbnf,%a ;GT same as LT but operands reversed\n",	/* stmt: GTU4(reg,reg) */
/* 220 */	"\tjcI4 R%1,R%0,lbdf,%a ;LE is flipped test & operands\n",	/* stmt: LEI4(reg,reg) */
/* 221 */	"\tjcU4 R%1,R%0,lbdf,%a ;LE is flipped test & operands\n",	/* stmt: LEU4(reg,reg) */
/* 222 */	"\tjcI4 R%0,R%1,lbnf,%a; LT=lbnf i.e. subtract B from A and jump if borrow \n",	/* stmt: LTI4(reg,reg) */
/* 223 */	"\tjcU4 R%0,R%1,lbnf,%a; LT=lbnf i.e. subtract B from A and jump if borrow \n",	/* stmt: LTU4(reg,reg) */
/* 224 */	"\tjneU4 R%0,R%1,%a; NE\n",	/* stmt: NEI4(reg,reg) */
/* 225 */	"\tjneU4 R%0,R%1,%a; NE\n",	/* stmt: NEU4(reg,reg) */
/* 226 */	"\tjeqU1I R%0,%1,%a;EQI2(CVUI2(reg),con8bit)**\n",	/* stmt: EQI2(CVUI2(reg),con8bit) */
/* 227 */	"\tjeqU2I R%0,%1,%a;EQI2(reg,con)\n",	/* stmt: EQI2(reg,con) */
/* 228 */	"\tjeqU4I R%0,%1,%a\n",	/* stmt: EQI4(reg,con) */
/* 229 */	"\tjeqU2I R%0,%1,%a;EQU2(reg,con)*\n",	/* stmt: EQU2(reg,con) */
/* 230 */	"\tjeqU4I R%0,%1,%a\n",	/* stmt: EQU4(reg,con) */
/* 231 */	"\tjcI2I R%0,%1,lbdf,%a; GE is flipped test from LT\n",	/* stmt: GEI2(reg,con) */
/* 232 */	"\tjgeI4I R%0,%1,%a; GE\n",	/* stmt: GEI4(reg,con) */
/* 233 */	"\tjcI2I R%0,%1,lbdf,%a; GE is flipped test from LT\n",	/* stmt: GEU2(reg,con) */
/* 234 */	"\tjgeU4I R%0,%1,%a; GE\n",	/* stmt: GEU4(reg,con) */
/* 235 */	"\tjnI2I R%0,%1,lbnf,%a; GT reverse  the subtraction\n",	/* stmt: GTI2(reg,con) */
/* 236 */	"\tjgtI4I R%0,%1,%a\n",	/* stmt: GTI4(reg,con) */
/* 237 */	"\tjnU2I R%0,%1,lbnf,%a; GT reverse the subtraction\n",	/* stmt: GTU2(reg,con) */
/* 238 */	"\tjgtU4I R%0,%1,%a\n",	/* stmt: GTU4(reg,con) */
/* 239 */	"\tjnI2I R%0,%1,lbdf,%a ;LEI2 %1 %0 %a; LE is flipped test & subtraction\n",	/* stmt: LEI2(reg,con) */
/* 240 */	"\tjleI4I R%0,%1,%a\n",	/* stmt: LEI4(reg,con) */
/* 241 */	"\tjnU2I R%0,%1,lbdf,%a ;LEU2 %1 %0 %a; LE is flipped test & subtraction\n",	/* stmt: LEU2(reg,con) */
/* 242 */	"\tjleU4I R%0,%1,%a\n",	/* stmt: LEU4(reg,con) */
/* 243 */	"\tjcI2I R%0,%1,lbnf,%a  ;LT=lbnf i.e. subtract immedB from A and jump if borrow\n",	/* stmt: LTI2(reg,con) */
/* 244 */	"\tjltI4I R%0,%1,%a\n",	/* stmt: LTI4(reg,con) */
/* 245 */	"\tjcU2I R%0,%1,lbnf,%a ;LT=lbnf i.e. subtract immedB from A and jump if borrow\n",	/* stmt: LTU2(reg,con) */
/* 246 */	"\tjltU4I R%0,%1,%a\n",	/* stmt: LTU4(reg,con) */
/* 247 */	"\tjnzU1 R%0,%a; NEI2(CVUI2(reg),con0)\n",	/* stmt: NEI2(CVUI2(reg),con0) */
/* 248 */	"\tjnzU2 R%0,%a; NE 0\n",	/* stmt: NEI2(reg,con0) */
/* 249 */	"\tjzU2 R%0,%a; EQ 0\n",	/* stmt: EQI2(reg,con0) */
/* 250 */	"\tjzU2 R%0,%a; EQ 0\n",	/* stmt: EQU2(reg,con0) */
/* 251 */	"\tjneU2I R%0,%1,%a; NE\n",	/* stmt: NEI2(reg,con) */
/* 252 */	"\tjneI4I R%0,%1,%a; NE\n",	/* stmt: NEI4(reg,con) */
/* 253 */	"\tjnzU2 R%0,%a; NE 0 \n",	/* stmt: NEU2(reg,con0) */
/* 254 */	"\tjneU2I R%0,%1,%a; NE\n",	/* stmt: NEU2(reg,con) */
/* 255 */	"\tjneU4IR R%0,%1,%a; NE\n",	/* stmt: NEU4(reg,con) */
/* 256 */	"\tjneU1I R%0,%1,%a	; DH 4\n",	/* stmt: NEI2(CVUI2(reg),con8bit) */
/* 257 */	"\tjeqI4 R%0,R%1,%a; EQF4(reg,reg)\n",	/* stmt: EQF4(reg,reg) */
/* 258 */	"\tjcF4 R%1,R%0,lbnf,%a;GTF4(reg,reg) - reverse operands\n",	/* stmt: GTF4(reg,reg) */
/* 259 */	"\tjcF4 R%0,R%1,lbdf,%a;GEF4(reg,reg) - reverse test\n",	/* stmt: GEF4(reg,reg) */
/* 260 */	"\tjcF4 R%1,R%0,lbdf,%a; LEF4(reg,reg) - reverse test and operands\n",	/* stmt: LEF4(reg,reg) */
/* 261 */	"\tjcF4 R%0,R%1,lbnf,%a;LTF4(reg,reg)LT=lbnf i.e. subtract B from A and jump if borrow\n",	/* stmt: LTF4(reg,reg) */
/* 262 */	"\tjneU4 R%0,R%1,%a; NEF4(reg,reg)\n",	/* stmt: NEF4(reg,reg) */
/* 263 */	"%a",	/* ar: ADDRGP2 */
/* 264 */	"\tCcall %0;CALLF4(ar)\n",	/* reg: CALLF4(ar) */
/* 265 */	"\tCcall %0; CALLI2(ar)\n",	/* reg: CALLI2(ar) */
/* 266 */	"\tCcall %0; CALLI4(ar)\n",	/* reg: CALLI4(ar) */
/* 267 */	"\tCcall %0; CALLP2(ar)\n",	/* reg: CALLP2(ar) */
/* 268 */	"\tCcall %0;CALLU2(ar)*\n",	/* reg: CALLU2(ar) */
/* 269 */	"\tCcall %0; CALLU4(ar)\n",	/* reg: CALLU4(ar) */
/* 270 */	"\tCcall %0; CALLV(ar)\n",	/* stmt: CALLV(ar) */
/* 271 */	"R%0",	/* ar: reg */
/* 272 */	"%a",	/* ar: CNSTP2 */
/* 273 */	"# retn\n",	/* stmt: RETF4(reg) */
/* 274 */	"# retn\n",	/* stmt: RETI2(reg) */
...
/* 287 */	"\tblkcpy R%0,R%1,%a; ASGNB(reg,INDIRB(reg))\n",	/* stmt: ASGNB(reg,INDIRB(reg)) */
/* 288 */	"# emit inline assembly\n",	/* stmt: IASMV */
};
...
/* 47 */	1,	/* ?\tcpy2 R%c,R%0\n\tincm R%c,%1\n */
/* 48 */	1,	/* ?\tcpy2 R%c,R%0\n\tincm R%c,%1\n */
/* 49 */	1,	/* ?\tcpy2 R%c,R%0	;SUBI2(reg,consm)\n\tdecm R%c,%1	;SUBI2(reg,consm)\n */
/* 50 */	1,	/* ?\tcpy2 R%c,R%0	;SUBU2(reg,consm)\n\tdecm R%c,%1	;SUBU2(reg,consm)\n */
/* 51 */	1,	/* ?\tcpy2 R%c,R%0\n\tdecm R%c,%1	; SUBP2(reg,consm)\n */
/* 52 */	1,	/* \tld2z R%c; reg:con0\n */
...
/* 60 */	1,	/* \tstr1 R%1,%0; ASGNU1(indaddr,LOADU1(LOADU2(reg))) 18-03-21\n */
/* 61 */	1,	/* \tst2I %1,%0; ASGNI2(addr,acon)\n */
/* 62 */	1,	/* \tst2 R%1,%0; ASGNI2(addr,reg)\n */
/* 63 */	1,	/* \tst2 R%1,%0; ASGNI2(addr,LOADI2(reg)) 18-02-26\n */
/* 64 */	1,	/* \tst2 R%1,%0; ASGNU2(addr,reg)\n */
/* 65 */	1,	/* \tst2 R%1,%0; ASGNU2(addr,LOADU2(reg)) 18-02-26\n */
/* 66 */	1,	/* \tst2 R%1,%0; ASGNI2(addr,LOADI2(reg)) 18-03-22\n */
/* 67 */	1,	/* \tst2 R%1,%0; ASGNP2(addr,reg)\n */
/* 68 */	1,	/* \tst4 R%1,%0\n */
/* 69 */	1,	/* \tst4 R%1,%0; ASGNU4\n */
/* 70 */	1,	/* \tldn1 R%c,%0;reg:  INDIRI1(indaddr)\n */
/* 71 */	1,	/* \tldn1 R%c,%0;reg:  INDIRU1(indaddr)\n */
/* 72 */	1,	/* \tld1 R%c,%0\n */
/* 73 */	1,	/* \tld1 R%c,%0\n */
/* 74 */	1,	/* \tld2 R%c,%0 ;reg:INDIRI2(addr)\n */
/* 75 */	1,	/* \tld2 R%c,%0 ;reg:INDIRU2(addr)\n */
/* 76 */	1,	/* \tld2 R%c,%0 ;reg:INDIRP2(addr)\n */
/* 77 */	1,	/* \tld4 R%c,%0;reg:  INDIRI4(addr)\n */
/* 78 */	1,	/* \tld4 R%c,%0;reg:  INDIRU4(addr)\n */
/* 79 */	1,	/* \tld1 R%c,%0\n\tsExt R%c ;CVII2: widen signed char to signed int (sign extend)\n */
/* 80 */	1,	/* \tld1 R%c,%0\n\tzExt R%c ;CVUU2: widen unsigned char to signed int (zero extend)\n */
/* 81 */	1,	/* \tld1 R%c,%0\n\tzExt R%c ;CVUI2(INDIRU1(addr)): *widen unsigned char to signed int (zero extend)\n */
/* 82 */	1,	/* \tld1 R%c,%0\n\tsext R%c\n\tsext4 R%c ;CVII4: widen signed char to long int(sign extend)\n */
...
/* 87 */	1,	/* \tld2 R%c,%0\n\tzext4 R%c ;CVUI4: widen unsigned int to signed long (zero extend)\n */
/* 88 */	1,	/* \tCcall _divi2\n */
/* 89 */	1,	/* \tshri4I R%c,1; DIVI4(reg,2)\n */
/* 90 */	1,	/* \tCcall _divi4; DIVI4(reg,reg)\n */
/* 91 */	1,	/* \tCcall _divu2\n */
/* 92 */	1,	/* \tCcall _divu4\n */
/* 93 */	1,	/* \tCcall _modi2\n */
/* 94 */	1,	/* \tCcall _modi4\n */
/* 95 */	1,	/* \tCcall _modu2\n */
/* 96 */	1,	/* \tCcall _modu4\n */
/* 97 */	1,	/* \tCcall _mulu2; was mulI2 R%c,R%0,R%1\n */
/* 98 */	1,	/* #\tCcall _mul8bit(%0); was mulI2 R%c,R%0,R%1\n */
/* 99 */	1,	/* \tCcall _mulu4\n */
/* 100 */	1,	/* \tCcall _mulu2; was mulU2 R%c,R%0,R%1\n */
/* 101 */	1,	/* \tCcall _mulu4\n */
/* 102 */	1,	/* \talu2RRS R%c,R%0,%1,add,adc; ADDI2(r,INDIRI2(addr))	DH3\n */
/* 103 */	1,	/* \talu2 R%c,R%0,R%1,add,adc; ADDI2(r,r)\n */
/* 104 */	1,	/* \talu4 R%c,R%0,R%1,add,adc\n */
/* 105 */	1,	/* \talu2RRS R%c,R%0,%1,add,adc; ADDI2(r,INDIRP2(addr))	DH3.1\n */
/* 106 */	1,	/* \talu2 R%c,R%0,R%1,add,adc	;ADDP2(reg,reg)\n */
/* 107 */	1,	/* \talu2 R%c,R%0,R%1,add,adc; ADDU2(r,r)\n */
/* 108 */	1,	/* \talu4 R%c,R%0,R%1,add,adc\n */
/* 109 */	1,	/* \talu2 R%c,R%0,R%1,and,and\n */
/* 110 */	1,	/* \talu4 R%c,R%0,R%1,and,and\n */
/* 111 */	1,	/* \talu2 R%c,R%0,R%1,or,or\n */
/* 112 */	1,	/* \talu4 R%c,R%0,R%1,or,or\n */
/* 113 */	1,	/* \talu2 R%c,R%0,R%1,xor,xor\n */
/* 114 */	1,	/* \talu4 R%c,R%0,R%1,xor,xor\n */
/* 115 */	1,	/* \talu2 R%c,R%0,R%1,and,and; BANDU2(reg,reg)\n */
/* 116 */	1,	/* \talu4 R%c,R%0,R%1,and,and\n */
/* 117 */	1,	/* \talu2 R%c,R%0,R%1,or,or\n */
/* 118 */	1,	/* \talu4 R%c,R%0,R%1,or,or\n */
/* 119 */	1,	/* \talu2 R%c,R%0,R%1,xor,xor\n */
/* 120 */	1,	/* \talu4 R%c,R%0,R%1,xor,xor\n */
/* 121 */	1,	/* \talu2 R%c,R%0,R%1,sm,smb\n */
/* 122 */	1,	/* \talu4 R%c,R%0,R%1,sm,smb\n */
/* 123 */	1,	/* \talu2 R%c,R%0,R%1,sm,smb\n */
/* 124 */	1,	/* \talu2 R%c,R%0,R%1,sm,smb\n */
/* 125 */	1,	/* \talu4 R%c,R%0,R%1,sm,smb\n */
/* 126 */	1,	/* \talu2I R%c,R%0,%1,adi,adci; ADDI2(reg,con)\n */
/* 127 */	1,	/* \talu4I R%c,R%0,%1,adi,adci\n */
/* 128 */	1,	/* \talu2I R%c,R%0,%1,adi,adci; ADDP2(reg,con)\n */
/* 129 */	1,	/* \talu2I R%c,R%0,%1,adi,adci; ADDU2(reg,con)\n */
/* 130 */	1,	/* \talu4I R%c,R%0,%1,adi,adci\n */
/* 131 */	1,	/* \talu2I R%c,R%0,%1,ani,ani\n	;removed ?\tcpy2 R%c,R%0\n */
/* 132 */	1,	/* ?\tcpy4 R%c,R%0\n\talu4I R%c,R%0,%1,ani,ani\n */
/* 133 */	1,	/* \talu2I R%c,R%0,%1,ori,ori ;removed copy\n */
/* 134 */	1,	/* ?\tcpy4 R%c,R%0\n\talu4I R%c,R%0,%1,ori,ori\n */
/* 135 */	1,	/* \talu2I R%c,R%0,%1,xri,xri ;removed copy\n */
/* 136 */	1,	/* ?\tcpy4 R%c,R%0\n\talu2I R%c,R%0,%1,xri,xri\n */
/* 137 */	1,	/* \talu2I R%c,R%0,%1,ani,ani ;removed copy;BANDU2(reg,con)  \n */
/* 138 */	1,	/* ?\tcpy4 R%c,R%0\n\talu4I R%c,R%0,%1,ani,ani\n */
/* 139 */	1,	/* \talu2I R%c,R%0,%1,ori,ori ;removed copy\n */
/* 140 */	1,	/* ?\tcpy4 R%c,R%0\n\talu4I R%c,R%0,%1,ori,ori\n */
/* 141 */	1,	/* \talu2I R%c,R%0,%1,xri,xri ;removed copy\n */
/* 142 */	1,	/* ?\tcpy4 R%c,R%0\n\talu2I R%c,R%0,%1,xri,xri\n */
/* 143 */	1,	/* \talu2I R%c,R%0,%1,smi,smbi\n */
/* 144 */	1,	/* \talu4I R%c,R%0,%1,smi,smbi\n */
/* 145 */	1,	/* \talu2I R%c,R%0,%1,smi,smbi\n */
/* 146 */	1,	/* \talu2I R%c,R%0,%1,smi,smbi\n */
/* 147 */	1,	/* \talu4I R%c,R%0,%1,smi,smbi\n */
/* 148 */	1,	/* ?\tcpy2 R%c,R%0\n\tshl2R R%c,R%1; lshi2(r,r)\n */
/* 149 */	1,	/* ?\tcpy4 R%c,R%0\n\tshl4R R%c,R%1\n */
/* 150 */	1,	/* ?\tcpy2 R%c,R%0\n\tshl2R R%c,R%1; lshu2(r,r)\n */
/* 151 */	1,	/* ?\tcpy4 R%c,R%0\n\tshl4R R%c,R%1\n */
...
/* 162 */	1,	/* ?\tcpy2 R%c,R%0\n\tshrU2I R%c,%1\n */
/* 163 */	1,	/* ?\tcpy4 R%c,R%0\n\tshrU4I R%c,%1\n */
/* 164 */	1,	/* \talu2I R%c,R%0,-1,xri,xri; was?\tcpy2 R%c,R%0+xor2I R%c,-1\n */
/* 165 */	1,	/* \talu4I R%c,R%0,-1,xri,xri; was?\tcpy4 R%c,R%0+xor4I R%c,-1\n */
/* 166 */	1,	/* \talu2I R%c,R%0,-1,xri,xri; was?\tcpy2 R%c,R%0+xor2I R%c,-1\n */
/* 167 */	1,	/* \talu4I R%c,R%0,-1,xri,xri; was?\tcpy4 R%c,R%0+xor4I R%c,-1\n */
/* 168 */	1,	/* \tnegI2 R%c,R%0 ;was alu2I R%c,R%0,0,sdi,sdbi\n */
/* 169 */	1,	/* \tnegI4 R%c,R%0 ;was alu4I R%c,R%0,0,sdi,sdbi\n */
/* 170 */	1,	/* ?\tcpy1 R%c,R%0;LOADI1(reg)\n */
/* 171 */	1,	/* ?\tcpy1 R%c,R%0;LOADU1(reg)\n */
/* 172 */	1,	/* ?\tcpy2 R%c,R%0 ;LOADI2(reg)\n */
/* 173 */	1,	/* \tdecm R%c,%1	;LOADU2(SUBU2(reg,consm))\n */
/* 174 */	1,	/* ?\tcpy2 R%c,R%0 ;LOADU2*(reg)\n */
/* 175 */	1,	/* ?\tcpy4 R%c,R%0; LOADI4*\n */
/* 176 */	1,	/* ?\tcpy2 R%c,R%0 ;LOADP2(reg)\n */
/* 177 */	1,	/* ?\tcpy4 R%c,R%0; LOADU4(reg)\n */
/* 178 */	1,	/* \tld4 R%c,%0;INDIRF4(addr)\n */
/* 179 */	1,	/* \tst4 R%1,%0; ASGNF4(addr,reg)\n */
/* 180 */	1,	/* \tCcall fp_add ;ADDF4(reg,reg)\n */
/* 181 */	1,	/* \tCcall fp_div ;DIVF4(reg,reg)\n */
/* 182 */	1,	/* \tCcall fp_mul ;MULF4(reg,reg)\n */
/* 183 */	1,	/* \tCcall fp_sub ;SUBF4(reg,reg)\n */
/* 184 */	1,	/* ?\tcpy4 R%c,R%0; LOADU4(reg)\n */
/* 185 */	0,	/* \tnegf4 R%c,R%0; NEGF4(reg) */
/* 186 */	1,	/* ?\tcpy1 R%c,R%0\n\tsExt R%c ;CVII2: widen signed char to signed int (sign extend)\n */
/* 187 */	1,	/* ?\tcpy1 R%c,R%0\n\tsExt R%c ;CVIU2: widen signed char to signed int (sign extend)\n */
/* 188 */	1,	/* ?\tcpy1 R%c,R%0\n\tzExt R%c ;CVUI2(reg): widen unsigned char to signed int (zero extend)*\n */
/* 189 */	1,	/* ?\tcpy1 R%c,R%0\n\tzExt R%c ;CVUU2: widen unsigned char to unsigned int (zero extend)*\n */
...
/* 194 */	1,	/* ?\tcpy2 R%c,R%0\n\tzext4 R%c ; CVUU4\n */
/* 195 */	0,	/*  */
/* 196 */	1,	/* #\tcvif4 %c,%0 ; CVIF4(reg) convert int/long to float\n */
/* 197 */	1,	/* \tccall cvfi4; CVFI4(reg) convert float to long(should work for int's)\n */
/* 198 */	1,	/* \tccall cvfi4; CVFI4(reg) convert float to long\n */
/* 199 */	1,	/* %a:\n */
/* 200 */	1,	/* \tlbr %0\n */
/* 201 */	1,	/* \tjumpv R%0; JUMPV(reg)\n */
/* 202 */	1,	/* \tjeqI2 R%0,R%1,%a; EQI2(reg,reg)\n */
/* 203 */	1,	/* \tjeqI2 R%0,R%1,%a;EQU2(reg,reg)\n */
/* 204 */	1,	/* \tjcI2 R%0,R%1,lbdf,%a; GE is flipped test from LT\n */
/* 205 */	1,	/* \tjcU2 R%0,R%1,lbdf,%a; GE is flipped test from LT\n */
/* 206 */	1,	/* \tjcI2 R%1,R%0,lbnf,%a ;GT is reversed operands from LT\n */
/* 207 */	1,	/* \tjcU2 R%1,R%0,lbnf,%a ;GT same as LT but operands reversed\n */
/* 208 */	1,	/* \tjcI2 R%1,R%0,lbdf,%a ;LE is flipped test & operands\n */
/* 209 */	1,	/* \tjcU2 R%1,R%0,lbdf,%a ;LE is flipped test & operands\n */
/* 210 */	1,	/* \tjcI2 R%0,R%1,lbnf,%a; LT=lbnf i.e. subtract B from A and jump if borrow \n */
/* 211 */	1,	/* \tjcU2 R%0,R%1,lbnf,%a; LT=lbnf i.e. subtract B from A and jump if borrow \n */
/* 212 */	1,	/* \tjneU2 R%0,R%1,%a; NE\n */
/* 213 */	1,	/* \tjneU2 R%0,R%1,%a; NE\n */
/* 214 */	1,	/* \tjeqI4 R%0,R%1,%a\n */
/* 215 */	1,	/* \tjeqI4 R%0,R%1,%a\n */
/* 216 */	1,	/* \tjcI4 R%0,R%1,lbdf,%a; GE is flipped test from LT\n */
/* 217 */	1,	/* \tjcU4 R%0,R%1,lbdf,%a; GE is flipped test from LT\n */
/* 218 */	1,	/* \tjcI4 R%1,R%0,lbnf,%a ;GT is reveresed operands from LT\n */
/* 219 */	1,	/* \tjcU4 R%1,R%0,lbnf,%a ;GT same as LT but operands reversed\n */
/* 220 */	1,	/* \tjcI4 R%1,R%0,lbdf,%a ;LE is flipped test & operands\n */
/* 221 */	1,	/* \tjcU4 R%1,R%0,lbdf,%a ;LE is flipped test & operands\n */
/* 222 */	1,	/* \tjcI4 R%0,R%1,lbnf,%a; LT=lbnf i.e. subtract B from A and jump if borrow \n */
/* 223 */	1,	/* \tjcU4 R%0,R%1,lbnf,%a; LT=lbnf i.e. subtract B from A and jump if borrow \n */
/* 224 */	1,	/* \tjneU4 R%0,R%1,%a; NE\n */
/* 225 */	1,	/* \tjneU4 R%0,R%1,%a; NE\n */
/* 226 */	1,	/* \tjeqU1I R%0,%1,%a;EQI2(CVUI2(reg),con8bit)**\n */
/* 227 */	1,	/* \tjeqU2I R%0,%1,%a;EQI2(reg,con)\n */
/* 228 */	1,	/* \tjeqU4I R%0,%1,%a\n */
/* 229 */	1,	/* \tjeqU2I R%0,%1,%a;EQU2(reg,con)*\n */
/* 230 */	1,	/* \tjeqU4I R%0,%1,%a\n */
/* 231 */	1,	/* \tjcI2I R%0,%1,lbdf,%a; GE is flipped test from LT\n */
/* 232 */	1,	/* \tjgeI4I R%0,%1,%a; GE\n */
/* 233 */	1,	/* \tjcI2I R%0,%1,lbdf,%a; GE is flipped test from LT\n */
/* 234 */	1,	/* \tjgeU4I R%0,%1,%a; GE\n */
/* 235 */	1,	/* \tjnI2I R%0,%1,lbnf,%a; GT reverse  the subtraction\n */
/* 236 */	1,	/* \tjgtI4I R%0,%1,%a\n */
/* 237 */	1,	/* \tjnU2I R%0,%1,lbnf,%a; GT reverse the subtraction\n */
/* 238 */	1,	/* \tjgtU4I R%0,%1,%a\n */
/* 239 */	1,	/* \tjnI2I R%0,%1,lbdf,%a ;LEI2 %1 %0 %a; LE is flipped test & subtraction\n */
/* 240 */	1,	/* \tjleI4I R%0,%1,%a\n */
/* 241 */	1,	/* \tjnU2I R%0,%1,lbdf,%a ;LEU2 %1 %0 %a; LE is flipped test & subtraction\n */
/* 242 */	1,	/* \tjleU4I R%0,%1,%a\n */
/* 243 */	1,	/* \tjcI2I R%0,%1,lbnf,%a  ;LT=lbnf i.e. subtract immedB from A and jump if borrow\n */
/* 244 */	1,	/* \tjltI4I R%0,%1,%a\n */
/* 245 */	1,	/* \tjcU2I R%0,%1,lbnf,%a ;LT=lbnf i.e. subtract immedB from A and jump if borrow\n */
/* 246 */	1,	/* \tjltU4I R%0,%1,%a\n */
/* 247 */	1,	/* \tjnzU1 R%0,%a; NEI2(CVUI2(reg),con0)\n */
/* 248 */	1,	/* \tjnzU2 R%0,%a; NE 0\n */
/* 249 */	1,	/* \tjzU2 R%0,%a; EQ 0\n */
/* 250 */	1,	/* \tjzU2 R%0,%a; EQ 0\n */
/* 251 */	1,	/* \tjneU2I R%0,%1,%a; NE\n */
/* 252 */	1,	/* \tjneI4I R%0,%1,%a; NE\n */
/* 253 */	1,	/* \tjnzU2 R%0,%a; NE 0 \n */
/* 254 */	1,	/* \tjneU2I R%0,%1,%a; NE\n */
/* 255 */	1,	/* \tjneU4IR R%0,%1,%a; NE\n */
/* 256 */	1,	/* \tjneU1I R%0,%1,%a	; DH 4\n */
/* 257 */	1,	/* \tjeqI4 R%0,R%1,%a; EQF4(reg,reg)\n */
/* 258 */	1,	/* \tjcF4 R%1,R%0,lbnf,%a;GTF4(reg,reg) - reverse operands\n */
/* 259 */	1,	/* \tjcF4 R%0,R%1,lbdf,%a;GEF4(reg,reg) - reverse test\n */
/* 260 */	1,	/* \tjcF4 R%1,R%0,lbdf,%a; LEF4(reg,reg) - reverse test and operands\n */
/* 261 */	1,	/* \tjcF4 R%0,R%1,lbnf,%a;LTF4(reg,reg)LT=lbnf i.e. subtract B from A and jump if borrow\n */
/* 262 */	1,	/* \tjneU4 R%0,R%1,%a; NEF4(reg,reg)\n */
/* 263 */	0,	/* %a */
/* 264 */	1,	/* \tCcall %0;CALLF4(ar)\n */
/* 265 */	1,	/* \tCcall %0; CALLI2(ar)\n */
/* 266 */	1,	/* \tCcall %0; CALLI4(ar)\n */
/* 267 */	1,	/* \tCcall %0; CALLP2(ar)\n */
/* 268 */	1,	/* \tCcall %0;CALLU2(ar)*\n */
/* 269 */	1,	/* \tCcall %0; CALLU4(ar)\n */
/* 270 */	1,	/* \tCcall %0; CALLV(ar)\n */
/* 271 */	0,	/* R%0 */
/* 272 */	0,	/* %a */
/* 273 */	1,	/* # retn\n */
/* 274 */	1,	/* # retn\n */
...
/* 285 */	1,	/* # arg\n */
/* 286 */	1,	/* # argb %0\n */
/* 287 */	1,	/* \tblkcpy R%0,R%1,%a; ASGNB(reg,INDIRB(reg))\n */
/* 288 */	1,	/* # emit inline assembly\n */
};
...
/* 60 */	"stmt: ASGNU1(indaddr,LOADU1(LOADU2(reg)))",
/* 61 */	"stmt: ASGNI2(addr,acon)",
/* 62 */	"stmt: ASGNI2(addr,reg)",
/* 63 */	"stmt: ASGNI2(addr,LOADI2(reg))",
/* 64 */	"stmt: ASGNU2(addr,reg)",
/* 65 */	"stmt: ASGNU2(addr,LOADU2(reg))",
/* 66 */	"stmt: ASGNI2(addr,LOADI2(reg))",
/* 67 */	"stmt: ASGNP2(addr,reg)",
/* 68 */	"stmt: ASGNI4(addr,reg)",
/* 69 */	"stmt: ASGNU4(addr,reg)",
/* 70 */	"reg: INDIRI1(indaddr)",
/* 71 */	"reg: INDIRU1(indaddr)",
/* 72 */	"reg: INDIRI1(addr)",
/* 73 */	"reg: INDIRU1(addr)",
/* 74 */	"reg: INDIRI2(addr)",
/* 75 */	"reg: INDIRU2(addr)",
...
/* 77 */	"reg: INDIRI4(addr)",
/* 78 */	"reg: INDIRU4(addr)",
/* 79 */	"reg: CVII2(INDIRI1(addr))",
/* 80 */	"reg: CVUU2(INDIRU1(addr))",
/* 81 */	"reg: CVUI2(INDIRU1(addr))",
/* 82 */	"reg: CVII4(INDIRI1(addr))",
/* 83 */	"reg: CVII4(INDIRI2(addr))",
/* 84 */	"reg: CVUU4(INDIRU1(addr))",
/* 85 */	"reg: CVUU4(INDIRU2(addr))",
/* 86 */	"reg: CVUI4(INDIRU1(addr))",
/* 87 */	"reg: CVUI4(INDIRU2(addr))",
/* 88 */	"reg: DIVI2(reg,reg)",
/* 89 */	"reg: DIVI4(reg,con2)",
/* 90 */	"reg: DIVI4(reg,reg)",
/* 91 */	"reg: DIVU2(reg,reg)",
/* 92 */	"reg: DIVU4(reg,reg)",
/* 93 */	"reg: MODI2(reg,reg)",
/* 94 */	"reg: MODI4(reg,reg)",
/* 95 */	"reg: MODU2(reg,reg)",
/* 96 */	"reg: MODU4(reg,reg)",
/* 97 */	"reg: MULI2(reg,reg)",
/* 98 */	"reg: MULI2(con8bit,reg)",
/* 99 */	"reg: MULI4(reg,reg)",
/* 100 */	"reg: MULU2(reg,reg)",
/* 101 */	"reg: MULU4(reg,reg)",
/* 102 */	"reg: ADDI2(reg,INDIRI2(addr))",
/* 103 */	"reg: ADDI2(reg,reg)",
/* 104 */	"reg: ADDI4(reg,reg)",
/* 105 */	"reg: ADDP2(reg,INDIRP2(addr))",
/* 106 */	"reg: ADDP2(reg,reg)",
/* 107 */	"reg: ADDU2(reg,reg)",
/* 108 */	"reg: ADDU4(reg,reg)",
/* 109 */	"reg: BANDI2(reg,reg)",
/* 110 */	"reg: BANDI4(reg,reg)",
/* 111 */	"reg: BORI2(reg,reg)",
/* 112 */	"reg: BORI4(reg,reg)",
/* 113 */	"reg: BXORI2(reg,reg)",
/* 114 */	"reg: BXORI4(reg,reg)",
/* 115 */	"reg: BANDU2(reg,reg)",
/* 116 */	"reg: BANDU4(reg,reg)",
/* 117 */	"reg: BORU2(reg,reg)",
/* 118 */	"reg: BORU4(reg,reg)",
/* 119 */	"reg: BXORU2(reg,reg)",
/* 120 */	"reg: BXORU4(reg,reg)",
/* 121 */	"reg: SUBI2(reg,reg)",
/* 122 */	"reg: SUBI4(reg,reg)",
/* 123 */	"reg: SUBP2(reg,reg)",
/* 124 */	"reg: SUBU2(reg,reg)",
/* 125 */	"reg: SUBU4(reg,reg)",
/* 126 */	"reg: ADDI2(reg,con)",
/* 127 */	"reg: ADDI4(reg,con)",
/* 128 */	"reg: ADDP2(reg,con)",
/* 129 */	"reg: ADDU2(reg,con)",
/* 130 */	"reg: ADDU4(reg,con)",
/* 131 */	"reg: BANDI2(reg,con)",
/* 132 */	"reg: BANDI4(reg,con)",
/* 133 */	"reg: BORI2(reg,con)",
/* 134 */	"reg: BORI4(reg,con)",
/* 135 */	"reg: BXORI2(reg,con)",
/* 136 */	"reg: BXORI4(reg,con)",
/* 137 */	"reg: BANDU2(reg,con)",
/* 138 */	"reg: BANDU4(reg,con)",
/* 139 */	"reg: BORU2(reg,con)",
/* 140 */	"reg: BORU4(reg,con)",
/* 141 */	"reg: BXORU2(reg,con)",
/* 142 */	"reg: BXORU4(reg,con)",
/* 143 */	"reg: SUBI2(reg,con)",
/* 144 */	"reg: SUBI4(reg,con)",
/* 145 */	"reg: SUBP2(reg,con)",
/* 146 */	"reg: SUBU2(reg,con)",
/* 147 */	"reg: SUBU4(reg,con)",
/* 148 */	"reg: LSHI2(reg,reg)",
/* 149 */	"reg: LSHI4(reg,reg)",
/* 150 */	"reg: LSHU2(reg,reg)",
/* 151 */	"reg: LSHU4(reg,reg)",
/* 152 */	"reg: RSHI2(reg,reg)",
/* 153 */	"reg: RSHI4(reg,reg)",
/* 154 */	"reg: RSHU2(reg,reg)",
/* 155 */	"reg: RSHU4(reg,reg)",
/* 156 */	"reg: LSHI2(reg,con)",
/* 157 */	"reg: LSHI4(reg,con)",
/* 158 */	"reg: LSHU2(reg,con)",
/* 159 */	"reg: LSHU4(reg,con)",
/* 160 */	"reg: RSHI2(reg,con)",
/* 161 */	"reg: RSHI4(reg,con)",
/* 162 */	"reg: RSHU2(reg,con)",
/* 163 */	"reg: RSHU4(reg,con)",
/* 164 */	"reg: BCOMI2(reg)",
/* 165 */	"reg: BCOMI4(reg)",
/* 166 */	"reg: BCOMU2(reg)",
/* 167 */	"reg: BCOMU4(reg)",
...
/* 171 */	"reg: LOADU1(reg)",
/* 172 */	"reg: LOADI2(reg)",
/* 173 */	"reg: LOADU2(SUBU2(reg,consm))",
/* 174 */	"reg: LOADU2(reg)",
/* 175 */	"reg: LOADI4(reg)",
/* 176 */	"reg: LOADP2(reg)",
/* 177 */	"reg: LOADU4(reg)",
/* 178 */	"reg: INDIRF4(addr)",
/* 179 */	"stmt: ASGNF4(addr,reg)",
/* 180 */	"reg: ADDF4(reg,reg)",
/* 181 */	"reg: DIVF4(reg,reg)",
/* 182 */	"reg: MULF4(reg,reg)",
/* 183 */	"reg: SUBF4(reg,reg)",
/* 184 */	"reg: LOADF4(reg)",
/* 185 */	"reg: NEGF4(reg)",
/* 186 */	"reg: CVII2(reg)",
/* 187 */	"reg: CVIU2(reg)",
...
/* 190 */	"reg: CVII4(reg)",
/* 191 */	"reg: CVIU4(reg)",
/* 192 */	"reg: CVIU4(CVUI2(INDIRU1(addr)))",
/* 193 */	"reg: CVUI4(reg)",
/* 194 */	"reg: CVUU4(reg)",
/* 195 */	"reg: CVFF4(reg)",
/* 196 */	"reg: CVIF4(reg)",
...
/* 200 */	"stmt: JUMPV(acon)",
/* 201 */	"stmt: JUMPV(reg)",
/* 202 */	"stmt: EQI2(reg,reg)",
/* 203 */	"stmt: EQU2(reg,reg)",
/* 204 */	"stmt: GEI2(reg,reg)",
/* 205 */	"stmt: GEU2(reg,reg)",
/* 206 */	"stmt: GTI2(reg,reg)",
/* 207 */	"stmt: GTU2(reg,reg)",
/* 208 */	"stmt: LEI2(reg,reg)",
/* 209 */	"stmt: LEU2(reg,reg)",
/* 210 */	"stmt: LTI2(reg,reg)",
/* 211 */	"stmt: LTU2(reg,reg)",
/* 212 */	"stmt: NEI2(reg,reg)",
/* 213 */	"stmt: NEU2(reg,reg)",
/* 214 */	"stmt: EQI4(reg,reg)",
/* 215 */	"stmt: EQU4(reg,reg)",
/* 216 */	"stmt: GEI4(reg,reg)",
/* 217 */	"stmt: GEU4(reg,reg)",
/* 218 */	"stmt: GTI4(reg,reg)",
/* 219 */	"stmt: GTU4(reg,reg)",
/* 220 */	"stmt: LEI4(reg,reg)",
/* 221 */	"stmt: LEU4(reg,reg)",
/* 222 */	"stmt: LTI4(reg,reg)",
/* 223 */	"stmt: LTU4(reg,reg)",
/* 224 */	"stmt: NEI4(reg,reg)",
/* 225 */	"stmt: NEU4(reg,reg)",
/* 226 */	"stmt: EQI2(CVUI2(reg),con8bit)",
/* 227 */	"stmt: EQI2(reg,con)",
/* 228 */	"stmt: EQI4(reg,con)",
/* 229 */	"stmt: EQU2(reg,con)",
/* 230 */	"stmt: EQU4(reg,con)",
/* 231 */	"stmt: GEI2(reg,con)",
/* 232 */	"stmt: GEI4(reg,con)",
/* 233 */	"stmt: GEU2(reg,con)",
/* 234 */	"stmt: GEU4(reg,con)",
/* 235 */	"stmt: GTI2(reg,con)",
/* 236 */	"stmt: GTI4(reg,con)",
/* 237 */	"stmt: GTU2(reg,con)",
/* 238 */	"stmt: GTU4(reg,con)",
/* 239 */	"stmt: LEI2(reg,con)",
/* 240 */	"stmt: LEI4(reg,con)",
/* 241 */	"stmt: LEU2(reg,con)",
/* 242 */	"stmt: LEU4(reg,con)",
/* 243 */	"stmt: LTI2(reg,con)",
/* 244 */	"stmt: LTI4(reg,con)",
/* 245 */	"stmt: LTU2(reg,con)",
/* 246 */	"stmt: LTU4(reg,con)",
/* 247 */	"stmt: NEI2(CVUI2(reg),con0)",
/* 248 */	"stmt: NEI2(reg,con0)",
/* 249 */	"stmt: EQI2(reg,con0)",
/* 250 */	"stmt: EQU2(reg,con0)",
/* 251 */	"stmt: NEI2(reg,con)",
/* 252 */	"stmt: NEI4(reg,con)",
/* 253 */	"stmt: NEU2(reg,con0)",
/* 254 */	"stmt: NEU2(reg,con)",
/* 255 */	"stmt: NEU4(reg,con)",
/* 256 */	"stmt: NEI2(CVUI2(reg),con8bit)",
/* 257 */	"stmt: EQF4(reg,reg)",
/* 258 */	"stmt: GTF4(reg,reg)",
/* 259 */	"stmt: GEF4(reg,reg)",
/* 260 */	"stmt: LEF4(reg,reg)",
/* 261 */	"stmt: LTF4(reg,reg)",
/* 262 */	"stmt: NEF4(reg,reg)",
/* 263 */	"ar: ADDRGP2",
/* 264 */	"reg: CALLF4(ar)",
/* 265 */	"reg: CALLI2(ar)",
/* 266 */	"reg: CALLI4(ar)",
...
/* 284 */	"stmt: ARGU2(reg)",
/* 285 */	"stmt: ARGU4(reg)",
/* 286 */	"stmt: ARGB(INDIRB(reg))",
/* 287 */	"stmt: ASGNB(reg,INDIRB(reg))",
/* 288 */	"stmt: IASMV",
};
...
static void _label(NODEPTR_TYPE a) {
	...
	case 2533: /* EQI2 */
		...
		if (	/* stmt: EQI2(CVUI2(reg),con8bit) */
			...
			c = ((struct _state *)(LEFT_CHILD(LEFT_CHILD(a))->x.state))->cost[_reg_NT] + ((struct _state *)(RIGHT_CHILD(a)->x.state))->cost[_con8bit_NT] + 2;
			if (c + 0 < p->cost[_stmt_NT]) {
				p->cost[_stmt_NT] = c + 0;
				p->rule._stmt = 53;
			}
...
static void _kids(NODEPTR_TYPE p, int eruleno, NODEPTR_TYPE kids[]) {
	...
	case 35: /* stmt: reg */
		kids[0] = p;
		break;
	case 262: /* stmt: NEF4(reg,reg) */
	case 261: /* stmt: LTF4(reg,reg) */
	case 260: /* stmt: LEF4(reg,reg) */
	case 259: /* stmt: GEF4(reg,reg) */
	case 258: /* stmt: GTF4(reg,reg) */
	case 257: /* stmt: EQF4(reg,reg) */
	case 255: /* stmt: NEU4(reg,con) */
	case 254: /* stmt: NEU2(reg,con) */
	case 253: /* stmt: NEU2(reg,con0) */
	case 252: /* stmt: NEI4(reg,con) */
	case 251: /* stmt: NEI2(reg,con) */
	case 250: /* stmt: EQU2(reg,con0) */
	case 249: /* stmt: EQI2(reg,con0) */
	case 248: /* stmt: NEI2(reg,con0) */
	case 246: /* stmt: LTU4(reg,con) */
	case 245: /* stmt: LTU2(reg,con) */
	case 244: /* stmt: LTI4(reg,con) */
	case 243: /* stmt: LTI2(reg,con) */
	case 242: /* stmt: LEU4(reg,con) */
	case 241: /* stmt: LEU2(reg,con) */
	case 240: /* stmt: LEI4(reg,con) */
	case 239: /* stmt: LEI2(reg,con) */
	case 238: /* stmt: GTU4(reg,con) */
	case 237: /* stmt: GTU2(reg,con) */
	case 236: /* stmt: GTI4(reg,con) */
	case 235: /* stmt: GTI2(reg,con) */
	case 234: /* stmt: GEU4(reg,con) */
	case 233: /* stmt: GEU2(reg,con) */
	case 232: /* stmt: GEI4(reg,con) */
	case 231: /* stmt: GEI2(reg,con) */
	case 230: /* stmt: EQU4(reg,con) */
	case 229: /* stmt: EQU2(reg,con) */
	case 228: /* stmt: EQI4(reg,con) */
	case 227: /* stmt: EQI2(reg,con) */
	case 225: /* stmt: NEU4(reg,reg) */
	case 224: /* stmt: NEI4(reg,reg) */
	case 223: /* stmt: LTU4(reg,reg) */
	case 222: /* stmt: LTI4(reg,reg) */
	case 221: /* stmt: LEU4(reg,reg) */
	case 220: /* stmt: LEI4(reg,reg) */
	case 219: /* stmt: GTU4(reg,reg) */
	case 218: /* stmt: GTI4(reg,reg) */
	case 217: /* stmt: GEU4(reg,reg) */
	case 216: /* stmt: GEI4(reg,reg) */
	case 215: /* stmt: EQU4(reg,reg) */
	case 214: /* stmt: EQI4(reg,reg) */
	case 213: /* stmt: NEU2(reg,reg) */
	case 212: /* stmt: NEI2(reg,reg) */
	case 211: /* stmt: LTU2(reg,reg) */
	case 210: /* stmt: LTI2(reg,reg) */
	case 209: /* stmt: LEU2(reg,reg) */
	case 208: /* stmt: LEI2(reg,reg) */
	case 207: /* stmt: GTU2(reg,reg) */
	case 206: /* stmt: GTI2(reg,reg) */
	case 205: /* stmt: GEU2(reg,reg) */
	case 204: /* stmt: GEI2(reg,reg) */
	case 203: /* stmt: EQU2(reg,reg) */
	case 202: /* stmt: EQI2(reg,reg) */
	case 183: /* reg: SUBF4(reg,reg) */
	case 182: /* reg: MULF4(reg,reg) */
	case 181: /* reg: DIVF4(reg,reg) */
	case 180: /* reg: ADDF4(reg,reg) */
	case 179: /* stmt: ASGNF4(addr,reg) */
	case 163: /* reg: RSHU4(reg,con) */
	case 162: /* reg: RSHU2(reg,con) */
	case 161: /* reg: RSHI4(reg,con) */
	case 160: /* reg: RSHI2(reg,con) */
	case 159: /* reg: LSHU4(reg,con) */
	case 158: /* reg: LSHU2(reg,con) */
	case 157: /* reg: LSHI4(reg,con) */
	case 156: /* reg: LSHI2(reg,con) */
	case 155: /* reg: RSHU4(reg,reg) */
	case 154: /* reg: RSHU2(reg,reg) */
	case 153: /* reg: RSHI4(reg,reg) */
	case 152: /* reg: RSHI2(reg,reg) */
	case 151: /* reg: LSHU4(reg,reg) */
	case 150: /* reg: LSHU2(reg,reg) */
	case 149: /* reg: LSHI4(reg,reg) */
	case 148: /* reg: LSHI2(reg,reg) */
	case 147: /* reg: SUBU4(reg,con) */
	case 146: /* reg: SUBU2(reg,con) */
	case 145: /* reg: SUBP2(reg,con) */
	case 144: /* reg: SUBI4(reg,con) */
	case 143: /* reg: SUBI2(reg,con) */
	case 142: /* reg: BXORU4(reg,con) */
	case 141: /* reg: BXORU2(reg,con) */
	case 140: /* reg: BORU4(reg,con) */
	case 139: /* reg: BORU2(reg,con) */
	case 138: /* reg: BANDU4(reg,con) */
	case 137: /* reg: BANDU2(reg,con) */
	case 136: /* reg: BXORI4(reg,con) */
	case 135: /* reg: BXORI2(reg,con) */
	case 134: /* reg: BORI4(reg,con) */
	case 133: /* reg: BORI2(reg,con) */
	case 132: /* reg: BANDI4(reg,con) */
	case 131: /* reg: BANDI2(reg,con) */
	case 130: /* reg: ADDU4(reg,con) */
	case 129: /* reg: ADDU2(reg,con) */
	case 128: /* reg: ADDP2(reg,con) */
	case 127: /* reg: ADDI4(reg,con) */
	case 126: /* reg: ADDI2(reg,con) */
	case 125: /* reg: SUBU4(reg,reg) */
	case 124: /* reg: SUBU2(reg,reg) */
	case 123: /* reg: SUBP2(reg,reg) */
	case 122: /* reg: SUBI4(reg,reg) */
	case 121: /* reg: SUBI2(reg,reg) */
	case 120: /* reg: BXORU4(reg,reg) */
	case 119: /* reg: BXORU2(reg,reg) */
	case 118: /* reg: BORU4(reg,reg) */
	case 117: /* reg: BORU2(reg,reg) */
	case 116: /* reg: BANDU4(reg,reg) */
	case 115: /* reg: BANDU2(reg,reg) */
	case 114: /* reg: BXORI4(reg,reg) */
	case 113: /* reg: BXORI2(reg,reg) */
	case 112: /* reg: BORI4(reg,reg) */
	case 111: /* reg: BORI2(reg,reg) */
	case 110: /* reg: BANDI4(reg,reg) */
	case 109: /* reg: BANDI2(reg,reg) */
	case 108: /* reg: ADDU4(reg,reg) */
	case 107: /* reg: ADDU2(reg,reg) */
	case 106: /* reg: ADDP2(reg,reg) */
	case 104: /* reg: ADDI4(reg,reg) */
	case 103: /* reg: ADDI2(reg,reg) */
	case 101: /* reg: MULU4(reg,reg) */
	case 100: /* reg: MULU2(reg,reg) */
	case 99: /* reg: MULI4(reg,reg) */
	case 98: /* reg: MULI2(con8bit,reg) */
	case 97: /* reg: MULI2(reg,reg) */
	case 96: /* reg: MODU4(reg,reg) */
	case 95: /* reg: MODU2(reg,reg) */
	case 94: /* reg: MODI4(reg,reg) */
	case 93: /* reg: MODI2(reg,reg) */
	case 92: /* reg: DIVU4(reg,reg) */
	case 91: /* reg: DIVU2(reg,reg) */
	case 90: /* reg: DIVI4(reg,reg) */
	case 89: /* reg: DIVI4(reg,con2) */
	case 88: /* reg: DIVI2(reg,reg) */
	case 69: /* stmt: ASGNU4(addr,reg) */
	case 68: /* stmt: ASGNI4(addr,reg) */
	case 67: /* stmt: ASGNP2(addr,reg) */
	case 64: /* stmt: ASGNU2(addr,reg) */
	case 62: /* stmt: ASGNI2(addr,reg) */
	case 61: /* stmt: ASGNI2(addr,acon) */
	...
	case 38: /* addr: ADDI2(reg,acon) */
		...
		break;
	case 60: /* stmt: ASGNU1(indaddr,LOADU1(LOADU2(reg))) */
		kids[0] = LEFT_CHILD(p);
		kids[1] = LEFT_CHILD(LEFT_CHILD(RIGHT_CHILD(p)));
		break;
	case 287: /* stmt: ASGNB(reg,INDIRB(reg)) */
	case 105: /* reg: ADDP2(reg,INDIRP2(addr)) */
	case 102: /* reg: ADDI2(reg,INDIRI2(addr)) */
	case 66: /* stmt: ASGNI2(addr,LOADI2(reg)) */
	case 65: /* stmt: ASGNU2(addr,LOADU2(reg)) */
	case 63: /* stmt: ASGNI2(addr,LOADI2(reg)) */
		kids[0] = LEFT_CHILD(p);
		kids[1] = LEFT_CHILD(RIGHT_CHILD(p));
		break;
	case 285: /* stmt: ARGU4(reg) */
	case 284: /* stmt: ARGU2(reg) */
	case 283: /* stmt: ARGP2(reg) */
	case 282: /* stmt: ARGI4(reg) */
	case 281: /* stmt: ARGI2(reg) */
	case 280: /* stmt: ARGF4(reg) */
	case 279: /* stmt: RETV(reg) */
	case 278: /* stmt: RETP2(reg) */
	case 277: /* stmt: RETU4(reg) */
	case 276: /* stmt: RETU2(reg) */
	case 275: /* stmt: RETI4(reg) */
	case 274: /* stmt: RETI2(reg) */
	case 273: /* stmt: RETF4(reg) */
	case 270: /* stmt: CALLV(ar) */
	case 269: /* reg: CALLU4(ar) */
	case 268: /* reg: CALLU2(ar) */
	case 267: /* reg: CALLP2(ar) */
	case 266: /* reg: CALLI4(ar) */
	case 265: /* reg: CALLI2(ar) */
	case 264: /* reg: CALLF4(ar) */
	case 201: /* stmt: JUMPV(reg) */
	case 200: /* stmt: JUMPV(acon) */
	case 198: /* reg: CVFI4(reg) */
	case 197: /* reg: CVFI2(reg) */
	case 196: /* reg: CVIF4(reg) */
	case 195: /* reg: CVFF4(reg) */
	case 194: /* reg: CVUU4(reg) */
	case 193: /* reg: CVUI4(reg) */
	case 191: /* reg: CVIU4(reg) */
	case 190: /* reg: CVII4(reg) */
	case 189: /* reg: CVUU2(reg) */
	case 188: /* reg: CVUI2(reg) */
	case 187: /* reg: CVIU2(reg) */
	case 186: /* reg: CVII2(reg) */
	case 185: /* reg: NEGF4(reg) */
	case 184: /* reg: LOADF4(reg) */
	case 178: /* reg: INDIRF4(addr) */
	case 177: /* reg: LOADU4(reg) */
	case 176: /* reg: LOADP2(reg) */
	case 175: /* reg: LOADI4(reg) */
	case 174: /* reg: LOADU2(reg) */
	case 172: /* reg: LOADI2(reg) */
	case 171: /* reg: LOADU1(reg) */
	case 170: /* reg: LOADI1(reg) */
	case 169: /* reg: NEGI4(reg) */
	case 168: /* reg: NEGI2(reg) */
	case 167: /* reg: BCOMU4(reg) */
	case 166: /* reg: BCOMU2(reg) */
	case 165: /* reg: BCOMI4(reg) */
	case 164: /* reg: BCOMI2(reg) */
	case 78: /* reg: INDIRU4(addr) */
	case 77: /* reg: INDIRI4(addr) */
	case 76: /* reg: INDIRP2(addr) */
	case 75: /* reg: INDIRU2(addr) */
	case 74: /* reg: INDIRI2(addr) */
	case 73: /* reg: INDIRU1(addr) */
	case 72: /* reg: INDIRI1(addr) */
	case 71: /* reg: INDIRU1(indaddr) */
	case 70: /* reg: INDIRI1(indaddr) */
		kids[0] = LEFT_CHILD(p);
		break;
	case 286: /* stmt: ARGB(INDIRB(reg)) */
	case 87: /* reg: CVUI4(INDIRU2(addr)) */
	case 86: /* reg: CVUI4(INDIRU1(addr)) */
	case 85: /* reg: CVUU4(INDIRU2(addr)) */
	case 84: /* reg: CVUU4(INDIRU1(addr)) */
	case 83: /* reg: CVII4(INDIRI2(addr)) */
	case 82: /* reg: CVII4(INDIRI1(addr)) */
	case 81: /* reg: CVUI2(INDIRU1(addr)) */
	case 80: /* reg: CVUU2(INDIRU1(addr)) */
	case 79: /* reg: CVII2(INDIRI1(addr)) */
		kids[0] = LEFT_CHILD(LEFT_CHILD(p));
		break;
	case 173: /* reg: LOADU2(SUBU2(reg,consm)) */
		kids[0] = LEFT_CHILD(LEFT_CHILD(p));
		kids[1] = RIGHT_CHILD(LEFT_CHILD(p));
		break;
	case 192: /* reg: CVIU4(CVUI2(INDIRU1(addr))) */
		kids[0] = LEFT_CHILD(LEFT_CHILD(LEFT_CHILD(p)));
		break;
	case 256: /* stmt: NEI2(CVUI2(reg),con8bit) */
	case 247: /* stmt: NEI2(CVUI2(reg),con0) */
	case 226: /* stmt: EQI2(CVUI2(reg),con8bit) */
		kids[0] = LEFT_CHILD(LEFT_CHILD(p));
		kids[1] = RIGHT_CHILD(p);
		break;
	default:
