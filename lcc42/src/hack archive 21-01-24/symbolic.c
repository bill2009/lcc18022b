...
static Node I(gen)(Node p) {
	...
	for (n = 0; p; p = p->link) {
		...
		case INDIR:
			...
			break;
		default:
			fprintf(stderr,"oops oops oops symbolic.c:317 generic(p->op)=%d p->op=%d\n",generic(p->op),p->op);//wjr
			break; //wjr
			assert(0);
		}
		check(p);
...
Interface symbolicIR = {
	1, 1, 0,	/* char */
	1, 1, 0,	/* short was 2,1 was 2, 2, 0,*/
	1, 1, 0,	/* int was 2,1 was 2, 4, 0,*/
	2, 1, 0,	/* long was 2,1 was 4, 4, 0,*/
	4, 1, 0,	/* long long was 4, 4, 0,*/
	4, 1, 1,	/* float was 4,4*/
	4, 1, 1,	/* double was 4,4 */
	4, 1, 1,	/* long double was 8,8 */
	2, 1, 0,	/* pointer was 2,1 was 4, 4, 0,*/
	0, 1, 0,	/* struct was 0,4 */
	0,		/* little_endian */
	0,		/* mulops_calls */
	0,		/* wants_callb */
	1,		/* wants_argb */
